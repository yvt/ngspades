...
This crate is based on Steven Sheldon's [Rust wrapper for Apple's GCD](http://github.com/SSheldon/rust-dispatch),
which is licensed under the MIT license.

For platforms other than macOS, it also contains [XDispatch](http://opensource.mlba-team.de/xdispatch/), as well as
its dependencies including [libpthread_workqueue](http://mark.heily.com/libpthreadworkqueue) and
