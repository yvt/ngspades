...
///     use ngspf_core::{KeyedPropertyAccessor, KeyedProperty, ProducerFrame};
...
///
///     #![feature(conservative_impl_trait)]
///     use ngspf_core::{RefPropertyAccessor, ProducerFrame};
///     use ngspf_core::{RoPropertyAccessor, PropertyProducerRead};
///     use std::sync::Arc;
///
///     struct Pegasus {
///         derp: f32,
