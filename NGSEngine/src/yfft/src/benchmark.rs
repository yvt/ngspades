...
#[bench] fn simple_benchmark_real_00002(b: &mut Bencher) { run_single_real_benchmark(2, b); }
#[bench] fn simple_benchmark_real_00004(b: &mut Bencher) { run_single_real_benchmark(4, b); }
#[bench] fn simple_benchmark_real_00008(b: &mut Bencher) { run_single_real_benchmark(8, b); }
#[bench] fn simple_benchmark_real_00016(b: &mut Bencher) { run_single_real_benchmark(16, b); }
#[bench] fn simple_benchmark_real_00032(b: &mut Bencher) { run_single_real_benchmark(32, b); }
#[bench] fn simple_benchmark_real_00064(b: &mut Bencher) { run_single_real_benchmark(64, b); }
#[bench] fn simple_benchmark_real_00128(b: &mut Bencher) { run_single_real_benchmark(128, b); }
#[bench] fn simple_benchmark_real_00256(b: &mut Bencher) { run_single_real_benchmark(256, b); }
#[bench] fn simple_benchmark_real_00512(b: &mut Bencher) { run_single_real_benchmark(512, b); }
#[bench] fn simple_benchmark_real_01024(b: &mut Bencher) { run_single_real_benchmark(1024, b); }
#[bench] fn simple_benchmark_real_02048(b: &mut Bencher) { run_single_real_benchmark(2048, b); }
#[bench] fn simple_benchmark_real_04096(b: &mut Bencher) { run_single_real_benchmark(4096, b); }
#[bench] fn simple_benchmark_real_08192(b: &mut Bencher) { run_single_real_benchmark(8192, b); }
#[bench] fn simple_benchmark_real_16384(b: &mut Bencher) { run_single_real_benchmark(16384, b); }
