//! # Procedural Macro for Nightingales Enumflags
//!
...
#[proc_macro_derive(NgsEnumFlags, attributes(NgsEnumFlags))]
...
fn gen_enumflags(ident: &Ident, item: &MacroInput, data: &Vec<Variant>) -> Tokens {
    ...
    quote!{
        ...
        impl ::ngsenumflags::InnerBitFlags for #inner_name{
            type Type = #ty;
            fn all() -> Self {
        ...
        impl Into<::ngsenumflags::BitFlags<#ident>> for #inner_name{
            fn into(self) -> ::ngsenumflags::BitFlags<#ident> {
                unsafe{ ::ngsenumflags::BitFlags::new(self)}
            }
        }
        ...
        impl #ident{
           pub fn from_bitflag(bitflag: ::ngsenumflags::BitFlags<#ident>) -> Vec<#ident> {
           ...
           pub fn max_bitflag() -> ::ngsenumflags::BitFlags<#ident> {
               let val = (#(#flag_values_ref1)|*) as #ty;
               unsafe{ ::ngsenumflags::BitFlags::new(#inner_name(val)) }
           }

           pub fn empty_bitflag() -> ::ngsenumflags::BitFlags<#ident>{
               unsafe{ ::ngsenumflags::BitFlags::new(#inner_name(0)) }
           }
        }

        impl From<#ident> for ::ngsenumflags::BitFlags<#ident> {
            fn from(t: #ident) -> Self {
                unsafe { ::ngsenumflags::BitFlags::new(t.into()) }
            }
        }

        impl ::std::ops::BitOr for #ident {
            type Output = ::ngsenumflags::BitFlags<#ident>;
